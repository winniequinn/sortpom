...
class IndentCharactersParameterTest {
  ...
  void zeroIndentCharactersShouldResultInEmptyIndentString() {
    var pluginParameters = PluginParameters.builder().setIndent(0, true, false, false).build();
  ...
  void oneIndentCharacterShouldResultInOneSpace() {
    var pluginParameters = PluginParameters.builder().setIndent(1, true, false, false).build();
  ...
  void test255IndentCharacterShouldResultIn255Space() {
    var pluginParameters = PluginParameters.builder().setIndent(255, true, false, false).build();
  ...
  void minusTwoShouldFail() {
    Executable testMethod =
        () -> PluginParameters.builder().setIndent(-2, true, false, false).build();
  ...
  void moreThan255ShouldFail() {
    Executable testMethod =
        () -> PluginParameters.builder().setIndent(256, true, false, false).build();
